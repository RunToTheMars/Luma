...
public:
  ...
  class Data;
  class Binder;
  Binder bind (const GL::ShaderProgramBinderInterface &binderInterface) noexcept;
  ...
  private:
    ...
    Binder (const Renderer &renderer, const GL::ShaderProgramBinderInterface &binderInterface) noexcept;
